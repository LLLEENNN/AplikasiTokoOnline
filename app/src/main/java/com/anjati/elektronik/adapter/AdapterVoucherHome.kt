...
class AdapterVoucherHome(var activity: Activity, var data: ArrayList<Voucher>) : RecyclerView.Adapter<AdapterVoucherHome.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_voucher_home, parent, false)
        return Holder(view)
    }
